...
BASE_DIR = os.getcwd()  # 终端所在文件夹
thisdir = os.path.dirname(os.path.abspath(__file__))  # 当前文件所在文件夹
pthisdir = os.path.dirname(thisdir)
...
STATIC_DIR = os.path.join(pthisdir, "static")
...
HONEY_VAULT_ENCODING_SIZE = (
    HONEY_VAULT_GRAMMAR_SIZE + HONEY_VAULT_STORAGE_SIZE * PASSWORD_LENGTH
)
